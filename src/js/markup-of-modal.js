    ...
    <div class="movie movie__container" data-id="${id}">
        ...
        <div class="movie__container--rigth-side">
            ...
            <div class="movie__btn-container">
                <button type="submit" id="watched-btn" data-action="add-to-watched" class="movie__btn add-to-watch btn btn--accent"> add to Watched </button>
                <button type="submit" id="queue-btn" data-action="${queueStatus.data}" class="movie__btn btn"> ${queueStatus.text} </button>
            </div>
        </div>
         <button class="movie__btn btn search-for-trailer" type="button">Search for trailer</button>
