    ...
    <div class="dialog">
        ...
        <ul class="team__wrapper">
            <li class="team__card list">
                ...
                <ul class="team__social">
                    <li class="team__icon list">
                        <a class="team__git" href="https://github.com/TheMainOne" target="_blank">
                    ...
                    <li class="team__icon list">
                        <a class="team__git" href="https://www.linkedin.com/in/maksym-lvov-390617202/" target="_blank">
            ...
            <li class="team__card">
                ...
                <ul class="team__social">
                    <li class="team__icon list">
                        <a class="team__git" href="https://github.com/anastasia1756" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                                <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
                    ...
                    <li class="team__icon list">
                        <a class="team__git" href="http://linkedin.com/in/anastasiia-kolomiiets-frontend-developer" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon" width="16" height="16" style=" fill: rgba(66, 114, 247, 0.993)">
                                <use type="image/svg+xml" type="image/svg+xml" href="${sprite}#icon-linkedin"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                <img src="${Nataliia}" alt="Nataliia" class="team__image">
                    ...
                    <ul class="team__social">
                        <li class="team__icon list"><a class="team__git" href="https://github.com/Natatashkin" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                                <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                <img src="${Anastasia}" alt="Anastasia" class="team__image">
                    ...
                    <ul class="team__social">
                        <li class="team__icon list">
                            <a class="team__git" href="https://github.com/Malogon-Anastasia" target="_blank">
                                <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                                    <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                                </svg>
                            </a>
                        ...
                        <li class="team__icon list">
                            <a class="team__git" href="https://www.linkedin.com/in/anastasia-mal%D0%BEgon-835bb2207/" target="_blank">
                                <svg type="image/svg+xml" class="logo__icon" width="16" height="16" style=" fill: rgba(66, 114, 247, 0.993)">
                                    <use type="image/svg+xml" type="image/svg+xml" href="${sprite}#icon-linkedin"></use>
                                </svg>
                            </a>
                ...
                <li class="team__card">
                    ...
                    <ul class="team__social">
                        ...
                        <li class="team__icon list"><a class="team__git" href="https://linkedin.com" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon" width="16" height="16" style=" fill: rgba(66, 114, 247, 0.993)">
                                <use type="image/svg+xml" type="image/svg+xml" href="${sprite}#icon-linkedin"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                ...
                <ul class="team__social">
                   <li class="team__icon list">
                        <a class="team__git" href="https://github.com/AlexKarb" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                               <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                ...
                <ul class="team__social">
                    <li class="team__icon list">
                        <a class="team__git" href="https://github.com/drdolgiy" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                               <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                ...
                <ul class="team__social">
                    <li class="team__icon list">
                        <a class="team__git" href="https://github.com/dimahalaiskiy/" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                               <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
            ...
            <li class="team__card">
                ...
                <ul class="team__social">
                    <li class="team__icon list">
                        <a class="team__git" href="https://github.com/KostiantynO" target="_blank">
                            <svg type="image/svg+xml" class="logo__icon logo__icon-git" width="16" height="16" style="fill: black">
                               <use type="image/svg+xml" href="${sprite}#icon-github"></use>
                            </svg>
                        </a>
